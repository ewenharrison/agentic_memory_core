...
## Overview
Short description of the project and why it exists.
...
Write the durable high-signal points you want future agent sessions to know immediately.
...
## Important Sources
- Add links to approved source notes here.
